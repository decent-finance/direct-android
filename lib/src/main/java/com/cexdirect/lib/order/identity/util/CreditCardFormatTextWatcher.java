...
public class CreditCardFormatTextWatcher implements TextWatcher {
    ...
    /**
     * Create a credit card formatter with no max length and a padding of 1 em (depends on text
     * size).
     * <p>
     * The padding is not automatically updated if the text size or typeface are changed in the
     * textview).
     *
    ...
    /**
     * Create a credit card formatter with no max length and a padding specified in em (depends on
     * text size).
     * <p>
     * The padding is not automatically updated if the text size or typeface are changed in the
     * textview).
    ...
    /**
     * Create a credit card formatter with no max length and a padding specified in SP Unit (depends
     * on the scale applied to text).
     *
    ...
    public void setPaddingSp(@NonNull Context context, float paddingSp) {
        setPaddingPx((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, paddingSp,
    ...
    /**
     * Format the provided widget card number (useful if you want to reformat it after changing
     * padding)
     *
