...
interface OrderService {
    ...
    @POST("v1/orders/send2processing")
    ...
    @POST("v1/orders/resend-check-code")
    ...
    @PUT("v1/orders/image")
    fun uploadImage(@Body body: ImageBody): Deferred<UploadImageResponse>

    @POST("v1/orders/crypto/verification")
    fun getVerificationPublicKey(@Body body: PublicKeyBody): Deferred<PublicKeyResponse>

    @POST("v1/orders/crypto/processing")
    ...
    @POST("v1/orders/send2verification")
