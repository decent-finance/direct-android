...
class ProcessingBody(data: ProcessingData) : BaseBody<ProcessingData>(data = data) {
    init {
...
data class ProcessingData(
    ...
    val cardData: ProcessingCardData,
    val channel: String = "android",
    val secretId: String = "123"
)

data class ProcessingCardData(
    val chash: String,
    val rcid: String
)
